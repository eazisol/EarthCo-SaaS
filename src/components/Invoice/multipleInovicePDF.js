...
const InvoicePDFMuliple = ({ data = [] }) => {
  const logoPath = data[0]?.dynamicColorAndLogo?.CompanyLogoPath;
        ...
        <Page size="A4" orientation="portrait" key={index}>
          <View style={[s.containerFluid]}>
            <View style={[s.row, { position: "relative" }]}>
              ...
              <View style={[s.col4]}>
                {/* <Text style={s.text}>{invoice?.SelectedCompany}</Text>
                ...
                <PdfAddress companyInfo={invoice?.companyInfo} website={true} email={true}/>
              ...
              <View style={[s.col8, { marginTop: "10px" }]}>
                ...
                <Text style={s.text}>{invoice?.Data.CustomerCompanyName}</Text>
                <Text style={s.text}>
                  {invoice?.Data.CustomerAddress?.split(", ")
                    .slice(0, 2)
                    .join(", ")}
                </Text>
                <Text style={s.text}>
                ...
                {/* <Text style={s.text}>{invoice?.Data.DocNumber}</Text>
                <Text style={s.text}>{invoice?.Data.InvoiceNumber}</Text>
                <Text style={s.text}>{invoice?.Data.ContactAddress}</Text> */}
              </View>
              ...
              >
                <Text style={s.tblText}>{invoice?.Data.InvoiceNumber}</Text>
              </View>
              <View
                style={[
                  s.col2,
              ...
              >
                <Text style={s.tblText}>
                  {formatDate(invoice?.Data.IssueDate, false)}
                </Text>
              </View>
              <View
                style={[
              ...
              >
                <Text style={s.tblText}>
                  ${formatAmount(invoice?.Data?.TotalAmount)}
                </Text>
              </View>
              <View
                style={[
              ...
              >
                <Text style={s.tblText}>
                  {" "}
                  {formatDate(invoice?.Data.DueDate, false)}
                </Text>
              </View>
              <View
                style={[
              ...
              >
                <Text style={s.tblText}>{invoice?.Data.Term}</Text>
              </View>
              <View
                style={[
                  s.col2,
              ...
              >
                <Text style={s.tblText}>
                  {invoice?.Data.StatusId === 0 ? "Closed" : "Open"}
                </Text>
              </View>

              <View style={[s.col12, { marginTop: "20px" }]}>
                <Text style={s.textBold}>Description of work:</Text>
                <Text style={s.text}>{invoice?.Data.CustomerMessage}</Text>
              </View>
            ...
            >
              <Text style={s.text}>${formatAmount(invoice.Amount)}</Text>
            </View> */}
              ...
              {invoice?.FileData.map((img, index) => {
...
export default InvoicePDFMuliple;
