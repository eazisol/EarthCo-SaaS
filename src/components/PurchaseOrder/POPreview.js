...
const POPreview = () => {
  ...
  const { POData, toggleFullscreen, setToggleFullscreen ,setselectedPdf, dynamicColorAndLogo } =
  ...
  useEffect(() => {
    ...
    if (PoPreviewData && PoPreviewData.ItemData) {
      const total = PoPreviewData.ItemData.reduce((accumulator, item) => {
                          ...
                          <tr>
                            <td className="p-0">
                              <h6 className="mb-0 mt-3">
                                ...
                                {PoPreviewData.Data.SupplierCompanyName || ""}
                              </h6>
                              <h6 className="mb-3">
                      ...
                      <table className="preview-table">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td className="table-cell-align text-start">
                              <h6>
                                &nbsp;{PoPreviewData.Data.RequestedByFirstName}
                                &nbsp;{PoPreviewData.Data.RequestedByLastName}
                              </h6>
                            </td>
                          </tr>
                        </tbody>
          ...
          <div className={toggleFullscreen ? "row ms-2" : ""}>
            <div className="d-flex align-items-end flex-column bd-highlight mb-3">
              ...
              <div className="p-2 pt-0 bd-highlight">
                ...
                <PDFDownloadLink
                  document={
                    <POPdf data={{ ...PoPreviewData, Total: totalAmount ,dynamicColorAndLogo: dynamicColorAndLogo}} />
                  }
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      // navigate(`/send-mail?title=${"Purchase Order"}`);
                       navigate(
                                  `/send-mail?title=${"Purchase Order"}&mail=${""}&customer=${
                                    PoPreviewData.Data.SupplierCompanyName
                                  }&number=${PoPreviewData.Data.PurchaseOrderNumber}`
                                );
                                setselectedPdf([])
                    }}
                  >
